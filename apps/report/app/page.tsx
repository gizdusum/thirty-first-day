...
/**
 * The two platform marks.
 *
 * Sized in `em` against the cap height of the label they sit in, so they track
 * the text at every breakpoint, and `fill="currentColor"` so they take the
 * token colour and invert with the dark scheme like everything else. They are
 * the only icons on the page and are meant to be barely noticed.
 */
function MarkX() {
  return (
